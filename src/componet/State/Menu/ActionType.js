...
export const CREATE_MENU_ITEM_FAILURE = 'CREATE_MENU_ITEM_REQUEST';
...
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_FAILURE = 'GET_MENU_ITEMS_BY_RESTAURANT_ID_REQUEST';
